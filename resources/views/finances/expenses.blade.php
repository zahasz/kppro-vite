...
<div class="py-6">
    <div class="max-w-[1920px] mx-auto sm:px-4 lg:px-6">
        <div class="mb-6 flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800">{{ __('Koszty') }}</h2>
            <div class="flex items-center space-x-2">
                ...
                <button class="btn flex items-center space-x-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-all duration-200">
                    ...
                    <span class="text-sm">Dodaj koszt</span>
                </button>
            </div>
        </div>
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                    ...
                    <div class="bg-white bg-opacity-10 backdrop-blur-sm overflow-hidden shadow-sm sm:rounded-md relative">
                        ...
                        <div class="p-3 relative z-10">
                            <h4 class="text-xs font-semibold text-gray-700 mb-1.5 whitespace-nowrap">Koszt roczny</h4>
                            <p class="text-xl font-bold text-red-600">98 000 zł</p>
                            <div class="mt-1.5 h-1 bg-gray-200 rounded-full overflow-hidden">
                                <div class="h-full bg-red-500 bg-opacity-10" style="width: 85%"></div>
                            </div>
                            <p class="text-[10px] text-gray-500 mt-1">85% budżetu rocznego</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white bg-opacity-10 backdrop-blur-sm overflow-hidden shadow-sm sm:rounded-md relative">
                        ...
                        <div class="p-3 relative z-10">
                            <h4 class="text-xs font-semibold text-gray-700 mb-1.5 whitespace-nowrap">Średni koszt</h4>
                            <p class="text-xl font-bold text-blue-600">8 166 zł</p>
                            <div class="mt-1.5 h-1 bg-gray-200 rounded-full overflow-hidden">
                    ...
                    <div class="bg-white bg-opacity-10 backdrop-blur-sm overflow-hidden shadow-sm sm:rounded-md relative">
                        ...
                        <div class="p-3 relative z-10">
                            ...
                            <p class="text-xl font-bold text-amber-600">12 400 zł</p>
                            <div class="mt-1.5 h-1 bg-gray-200 rounded-full overflow-hidden">
                                <div class="h-full bg-amber-500 bg-opacity-10" style="width: 30%"></div>
                            </div>
                            <p class="text-[10px] text-gray-500 mt-1">Do zapłaty</p>
                        </div>
                    </div>
                </div>
