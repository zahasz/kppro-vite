...
<script>
    ...
    function openModal(type = null) {
        console.log('openModal wywołane', type);
        if (!modal) {
        ...
        // Ustawiamy domyślny typ w zależności od przycisku
        if (type) {
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-gray-50 p-4 rounded-lg">
                                ...
                                <span class="text-lg font-semibold text-amber-600">{{ number_format($investments ?? 0, 2, ',', ' ') }} zł</span>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg">
                                <span class="text-xs text-gray-500 block mb-1">Całkowity zwrot</span>
                                <span class="text-lg font-semibold text-green-600">+8.5%</span>
                            </div>
                        </div>

                        <div class="border-t pt-4">
                            <h4 class="text-sm font-medium text-gray-700 mb-3">Lista inwestycji</h4>
                            <div class="space-y-3">
                                <div class="bg-gray-50 p-3 rounded-lg">
                                    <div class="flex items-center justify-between text-sm mb-2">
                                        <p class="font-medium text-gray-700">Lokata terminowa</p>
                                        <span class="font-medium text-amber-600">50 000,00 zł</span>
                                    </div>
                                    <div class="flex items-center justify-between text-xs">
                                        <span class="text-gray-500">Oprocentowanie: 7.5%</span>
                                        <span class="text-green-600">+3 750,00 zł</span>
                                    </div>
                                </div>
                                <div class="bg-gray-50 p-3 rounded-lg">
                                    <div class="flex items-center justify-between text-sm mb-2">
                                        <p class="font-medium text-gray-700">Obligacje skarbowe</p>
                                        <span class="font-medium text-amber-600">25 000,00 zł</span>
                                    </div>
                                    <div class="flex items-center justify-between text-xs">
                                        <span class="text-gray-500">Oprocentowanie: 6.5%</span>
                                        <span class="text-green-600">+1 625,00 zł</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-t pt-4">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                    <p class="text-gray-500">Aktywne inwestycje</p>
                                    <p class="font-medium text-gray-700">3</p>
                                </div>
                                <div>
                                    <p class="text-gray-500">Średni zwrot</p>
                                    <p class="font-medium text-green-600">7.2%</p>
                                </div>
                                <div>
                                    <p class="text-gray-500">Najwyższy zwrot</p>
                                    <p class="font-medium text-green-600">8.5%</p>
                                </div>
                                <div>
                                    <p class="text-gray-500">Najniższy zwrot</p>
                                    <p class="font-medium text-amber-600">5.8%</p>
                                </div>
                            </div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            form.addEventListener('submit', function(e) {
                ...
                const plannedAmount = document.getElementById('planned_amount');
                let hasErrors = false;
                
                // Resetujemy style błędów
                amount.classList.remove('border-red-500');
                plannedAmount.classList.remove('border-red-500');
                ...
                if (isNaN(plannedAmount.value) || plannedAmount.value === '' || parseFloat(plannedAmount.value) < 0) {
                    e.preventDefault();
                    plannedAmount.classList.add('border-red-500');
                    alert('Proszę podać prawidłową kwotę planowaną (nie może być ujemna)');
                    hasErrors = true;
                }
                ...
                if (!hasErrors) {
                    ...
                    .catch(error => console.error('Błąd podczas zapisywania:', error));
                }
            });
        }
