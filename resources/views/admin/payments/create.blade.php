                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.payments.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Wprowadź podstawowe informacje o bramce płatności.</p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="code" name="code" value="{{ old('code') }}" required pattern="[a-z0-9_]+" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div class="mb-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="class_name" name="class_name" value="{{ old('class_name') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="display_order" name="display_order" value="{{ old('display_order', 0) }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Logo bramki płatności (opcjonalnie, maksymalny rozmiar: 1MB)</p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="flex items-center">
                                    <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" id="test_mode" name="test_mode" value="1" {{ old('test_mode', true) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-gray-600 mb-4">Wprowadź dane konfiguracyjne specyficzne dla wybranej bramki płatności.</p>
                            
                            <div id="config-fields">
                                <!-- Przykładowe pola konfiguracyjne -->
                        ...
                        <div class="flex items-center justify-end">
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white tracking-widest hover:bg-blue-700 active:bg-blue-800 focus:outline-none focus:border-blue-700 focus:ring ring-blue-300 disabled:opacity-25 transition">
                                <i class="fas fa-save mr-2"></i> Zapisz bramkę płatności
                            </button>
                        </div>
                    </form>
                </div>
