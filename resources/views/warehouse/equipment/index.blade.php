        ...
        <div class="max-w-[1920px] mx-auto sm:px-4 lg:px-6">
            <div class="flex flex-col gap-6">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-800">Magazyn sprzętu</h1>
                        <p class="text-sm text-gray-600">Zarządzaj sprzętem budowlanym i maszynami</p>
                    </div>
                    <a href="{{ route('warehouse.equipment.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        Dodaj sprzęt
                    </a>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm rounded-lg">
                    <div class="p-6">
                        <form action="{{ route('warehouse.equipment.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                <label for="search" class="block text-sm font-medium text-gray-700">Szukaj</label>
                                <input type="text" name="search" id="search" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Nazwa, numer seryjny...">
                            </div>
                            <div>
                                ...
                                <select name="category" id="category" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    ...
                                    <option value="heavy">Ciężki sprzęt</option>
                                    <option value="power">Elektronarzędzia</option>
                                    <option value="measurement">Sprzęt pomiarowy</option>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Ostatni przegląd</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Koparka JCB</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Ciężki sprzęt</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">250 000,00 zł</td>
