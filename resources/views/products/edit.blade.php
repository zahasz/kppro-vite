                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('products.update', $product) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" class="block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="unit_price" class="block mt-1 w-full" type="number" step="0.01" name="unit_price" :value="old('unit_price', $product->unit_price)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tax_rate" class="block mt-1 w-full" type="number" step="0.01" name="tax_rate" :value="old('tax_rate', $product->tax_rate)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="status" name="status" class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                <option value="active" {{ old('status', $product->status) == 'active' ? 'selected' : '' }}>Aktywny</option>
                                <option value="inactive" {{ old('status', $product->status) == 'inactive' ? 'selected' : '' }}>Nieaktywny</option>
                            </select>
