...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\kppro-vite\public\storage' => 'string',
            ...
            'permission.query_cache_expiration_time' => 'object',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\kppro-vite\\public\\storage',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','permission.cache.model_key','permission.query_cache_expiration_time',
...
'profile.update','profile.destroy','company-profile.update','contractors.index','contractors.create',
'contractors.store','contractors.show','contractors.edit','contractors.update','contractors.destroy',
'contractors.export-pdf','finances.index','finances.incomes','finances.expenses','finances.budget.index',
'finances.budget.store','finances.budget.update','finances.budget.destroy','finances.invoices.index','finances.reports',
'finances.invoices.sales','finances.invoices.purchases','warehouse.index','tasks.index','contracts.index',
'estimates.index','admin.dashboard','admin.users','admin.roles','admin.permissions',
'admin.users.update-roles','admin.roles.update-permissions','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.permissions.index','admin.roles.index','admin.users.index','auth.confirm-password',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','contractors','contracts.index',
'dashboard','estimates.index','finances.budget.index','finances.expenses','finances.incomes',
'finances.index','finances.scanner','home','layouts.admin','layouts.app',
'layouts.guest','layouts.navigation','layouts.sidebar','profile.edit','profile.index',
'profile.partials.company-profile-form','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','tasks.index',
'users.index','warehouse.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'DB_PASSWORD','CACHE_DRIVER','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
